                        ...
                        <el-row :gutter="20">
                            <el-col :span="24">
                                <div class="grid-content">
                                    <el-button type="primary" icon="el-icon-plus" plain size="mini" v-hasPermi="['btn:keypoint:add']" @click="handleAddKeyPoint">新增关键点</el-button>
                                </div>
                            </el-col>
                        </el-row>
                            ...
                            <el-col :span="24">
                                <el-table :data="formData" class='tableStyle' ref="keyPointForm" border>
                                    ...
                                    <el-table-column label="操作" width="200" align="center">
                                        ...
                                        <el-button type="danger"  icon="el-icon-delete" size="mini" v-hasPermi="['btn:keypoint:delete']" plain @click="handleKeyPointDel(scope.row.id)">删除</el-button>
                                        <el-button type="info" icon="el-icon-edit" plain size="mini" v-hasPermi="['btn:keypoint:update']" @click="showEditKeyPoint(scope.row)">修改</el-button>
                                        </template>
                                    </el-table-column>
                                </el-table>
                            </el-col>
                    ...
                    <el-tab-pane label="报告编制组件配置" name="second">
                         <el-alert style="margin-bottom:12px;"
                            ...
                            <div class="draw-opt">
                                ...
                                <el-button type="primary" @click="handleFormSetting" :loading="loading">{{ loading ? '提交中 ...' : '保  存' }}</el-button>
                            </div>
                    </el-tab-pane>
                </el-tabs>
            </div>
