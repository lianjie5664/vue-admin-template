<template>
  <div class="major_common">
    <el-row :gutter="10">
      <el-col :span="6">
        顾客总数：
        <span class="red fw700">{{formData.length}}</span> 家
      </el-col>
    </el-row>
    <table class="supply_table">
      ...
      <tbody>
        <tr v-for="(item,index) in formData" :key="index">
          <td>{{index + 1}}</td>
          <td>
            <input type="text" v-model="item.cname" class="noborIpt" />
          </td>
          <td>
            <input type="text" v-model="item.pname" class="noborIpt" />
          </td>
          <td>
            <input type="text" v-model="item.pcount" class="noborIpt" />
          </td>
          <td>
            <input type="text" v-model="item.unit" class="noborIpt" />
          </td>
          <td>
