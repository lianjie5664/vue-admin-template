    ...
    <table class="dataTable">
      ...
      <tbody>
        <tr v-for="(i,idx) in formData.body" :key="idx">
          ...
          <td>{{i.unit}}</td>
          <td>
            <input type="text" v-model="i.v1" class="noborIpt" />
          </td>
          <td>
            <input type="text" v-model="i.v2" class="noborIpt" />
          </td>
          <td>
            <input type="text" v-model="i.v3" class="noborIpt" />
          </td>
          <td>
            <input type="text" v-model="i.ranking" class="noborIpt" />
          </td>
        </tr>
      </tbody>
    </table>
