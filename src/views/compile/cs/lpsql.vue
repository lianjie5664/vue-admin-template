<template>
  <div class="lpsql-wrap">
    <el-row :gutter="10">
      ...
      <el-col :span="12">
        <el-alert title="备注：多个产品时，可以创建多个表格" type="info"></el-alert>
      </el-col>
    </el-row>
    <!-- 表格正文 -->
    <div class="mutiTable" v-for="(item,index) in formData" :key="index">
      <el-row :gutter="10" class="table-title">
        <el-col :span="6" align="center">产品（服务）名称：</el-col>
        <el-col :span="8">
                  ...
                  <el-row :gutter="10">
                    ...
                    <el-col :span="3" class="lh23">
                      <i
                        ...
                        title="新增行"
                        v-if="idx == item.dataList.length - 1"
                        @click="addRow(index)"
                      ></i>
                    </el-col>
                  </el-row>
