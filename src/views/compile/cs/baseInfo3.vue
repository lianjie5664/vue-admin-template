    ...
    <el-form ref="formData" :model="formData" label-width="180px">
      ...
      <el-row class="section">
        <el-col :span="24">
          <el-row :gutter="15">
            ...
            <el-col :span="8" class="item" align="center">
              <el-radio-group v-model="formData.honor[0].v1">
                <el-radio
                  :label="i.label"
                  v-for="(i,idx) in formData.honor[0].options"
                  :key="idx"
                >{{i.name}}</el-radio>
              </el-radio-group>
            </el-col>
          ...
          <el-row :gutter="15">
            <el-col :span="4" class="item">获奖产品名称：</el-col>
            <el-col :span="6" class="item">
              <el-input v-model="formData.honor[0].ipt2" :size="size" placeholder="请输入获奖产品名称"></el-input>
            </el-col>
            <el-col :span="3" class="item">获奖时间：</el-col>
            <el-col :span="5" class="item">
              <el-date-picker
                v-model="formData.honor[0].ipt3"
                :size="size"
                type="date"
                placeholder="请选择获奖时间"
              ></el-date-picker>
      ...
      <el-row class="section">
        <el-col :span="24">
          ...
          <el-row :gutter="15">
            <el-col :span="4" class="item">认定产品名称：</el-col>
            <el-col :span="6" class="item">
              <el-input v-model="formData.honor[1].ipt1" :size="size" placeholder="请输入认定产品名称"></el-input>
            </el-col>
            <el-col :span="3" class="item">认定时间：</el-col>
            <el-col :span="5" class="item">
              <el-date-picker
                v-model="formData.honor[1].ipt2"
                :size="size"
                type="date"
                placeholder="请选择认定时间"
              ></el-date-picker>
      ...
      <el-row class="section">
        <el-col :span="24">
          <el-row :gutter="15">
            ...
            <el-col :span="8" class="item" align="center">
              <el-radio-group v-model="formData.honor[2].v1">
                <el-radio
                  :label="i.label"
                  v-for="(i,idx) in formData.honor[2].options"
                  :key="idx"
                >{{i.name}}</el-radio>
              </el-radio-group>
            </el-col>
          ...
          <el-row :gutter="10">
            <el-col :span="4" align="right" class="item">认定产品名称：</el-col>
            <el-col :span="6" class="item">
              <el-input v-model="formData.honor[2].ipt1" :size="size" placeholder></el-input>
            </el-col>
            <el-col :span="3" class="item" align="right">认定时间：</el-col>
            <el-col :span="5" class="item">
              <el-date-picker
                v-model="formData.honor[2].ipt2"
                :size="size"
                type="date"
                placeholder="请选择认定时间"
              ></el-date-picker>
      ...
      <el-row class="section">
        <el-col :span="24">
          ...
          <el-row :gutter="10">
            <el-col :span="24" class="item">
              <el-radio-group v-model="formData.honor[3].v1">
                <el-radio
                  :label="i.label"
                  v-for="(i,idx) in formData.honor[3].options"
                  :key="idx"
                >{{i.name}}</el-radio>
              </el-radio-group>
            </el-col>
          ...
          <el-row :gutter="15">
            <el-col :span="6" class="item" align="center">获得产品或商标名称：</el-col>
            <el-col :span="6" class="item">
              <el-input v-model="formData.honor[3].ipt1" :size="size" placeholder="请输入产品或商标名称"></el-input>
            </el-col>
            <el-col :span="3" class="item" align="center">获得时间：</el-col>
            <el-col :span="5" class="item">
              <el-date-picker
                v-model="formData.honor[3].ipt2"
                :size="size"
                type="date"
                placeholder="请选择获得时间"
              ></el-date-picker>
      ...
      <el-row class="section">
        <el-col :span="24">
          ...
          <el-row>
            <el-col :span="4" align="right" class="item">获奖工程名称：</el-col>
            <el-col :span="6" class="item">
              <el-input v-model="formData.honor[4].ipt1" :size="size" placeholder="请输入获奖工程名称"></el-input>
            </el-col>
            <el-col :span="3" class="item" align="right">获得时间：</el-col>
            <el-col :span="5" class="item">
              <el-date-picker
                v-model="formData.honor[4].ipt2"
                :size="size"
                type="date"
                placeholder="请选择认定时间"
              ></el-date-picker>
        ...
        honor: [
          {
            ...
            chk: { label: "省级以上工程质量奖", value: true },
            v1: 2,
            ipt1: "",
            ipt2: "",
            ipt3: ""
          ...
          {
            chk: { label: "省级以上高新技术产品", value: true },
            ipt1: "",
            ipt2: ""
          },
          {
          ...
          },
          {
            ...
            chk: { label: "省级以上品牌荣誉", value: false }
          },
          {
            ipt1: "",
            ipt2: "",
            chk: { label: "省级以上工程质量奖", value: 0 }
          },
          {
            multiline: [
              {
                ipt1: { label: "认证名称：", value: "" },
                ipt2: { label: "获证产品名称：", value: "" },
                ipt3: { label: "获证时间：", value: "" },
                chk: { label: "强制性认证", value: true }
              },
              {
                ipt1: { label: "认证名称：", value: "" },
                ipt2: { label: "获证产品名称：", value: "" },
                ipt3: { label: "获证时间：", value: "" },
                chk: { label: "生产（制造）许可证", value: false }
              },
              {
                ipt1: { label: "认证名称：", value: "" },
                ipt2: { label: "获证产品名称：", value: "" },
                ipt3: { label: "获证时间：", value: "" },
                chk: { label: "其他（证书名称）", value: false }
              }
            ]
          }
        ]
